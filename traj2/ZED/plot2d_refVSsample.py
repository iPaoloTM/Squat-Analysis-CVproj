...
plt.scatter(plot_pelvis_gt[:, 0], plot_pelvis_gt[:, 1], c=plot_pelvis_gt[:, 1], cmap=cmap, norm=norm,  label='GROUDTRUTH', s=3)
# cbar = plt.colorbar()
...
plt.axis('equal')
# plt.show()
plt.savefig('../ZEDresults/PELVIS/pelvis_ZED_groundTruthVSsample'+str(sample)+'.png')
