...
ax.scatter(list_of_head_coord[:, 0], list_of_head_coord[:, 1], c='red', label='SAMPLE', s=3)
...
ax.scatter(list_of_head_coord[:, 0], list_of_head_coord[:, 2], c='red', label='SAMPLE')
...
for point in list_of_head_coord:
    ...
    distance = np.linalg.norm(point_coords - barycenter) # x y ZED x z zed
