...
ax.scatter(centered_coordinates[:, 0], centered_coordinates[:, 2], c='blue', label='SAMPLE', s=3)
ax.scatter(centered_coordinates_2[:, 0], centered_coordinates_2[:, 2], c='red', label='SAMPLE', s=3)
